...
class Empleado(Persona):
    def _init_(self, nombre, edad, genero, salario, puesto):
...
print(persona.nombre, "tiene un salario de:", empleado.salario, "y esta en el puesto #", empleado.puesto,
      "y en este momento", persona.nombre, empleado.trabajar())


class Estudiante(Persona):
    def _init_(self, nombre, edad, genero, grado, escuela):
        super()._init_(nombre, edad, genero)
        self.grado = grado
